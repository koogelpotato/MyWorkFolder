                                                  ...
                                                  position v2)
{
    ...
    for (auto [start, end] : { std::pair{ v0, v1 }, std::pair{ v1, v2 }, std::pair{ v2, v0 } })
    {
                                     ...
                                     color                  c)
{
    ...
    for (size_t i = 0; i < num_vertexes; i += 3)
    {
        ...
        triangles_edge_pixels.insert(triangles_edge_pixels.end(), pixels_pos_triangle.begin(), pixels_pos_triangle.end());
    }
